...
export default function Header({ page }) {
    ...
    return (
        <div id="header" className="bg-[#0052FE] border-b border-white">
            <ToastContainer />
            <div className="hidden sm:flex items-center gap-4 container mx-auto px-4 py-5 justify-between">
                ...
                {bal && <div className="flex items-center justify-center gap-3 w-4/12">
                ...
                {!user &&
                    <div className="px-10 flex justify-end w-4/12">
                        <div className="">
                            <button onClick={handleClick} className="rounded-md hover:animate-none font-black text-white text-center text-base bg-[#112330] p-4">
                                {!loading && "SIGN IN"}
                                {loading &&
                ...
                {user &&
                    <div className="px-10 flex justify-end w-4/12">
                        <div className="rounded-md flex flex-row items-center justify-center p-4 bg-[#112330] ">
                            <div className="basis-2/3">
                                <Link href="/bet" className="mr-2 text-white font-black text-xl">PLAY</Link>
                            </div>
                            <div className="basis-1/3">
                                <FaDice size={35} color="#fff" className="ml-2" />
                            </div>
                        </div>
                    </div>
                }
